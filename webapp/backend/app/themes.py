...
from .models import FormattingOptions, ThemePayload
...
def css_from_theme(theme: ThemePayload, formatting: FormattingOptions) -> str:
    ...
    page_border_shadow = _style_bool(
        styles,
        "page_border_shadow",
        "pageBorderShadow",
        default=False,
    )
    page_border_frame = _style_bool(
        styles,
        "page_border_frame",
        "pageBorderFrame",
        default=False,
    ...
    border_effect_css = ""
    if page_border_enabled and page_border_shadow:
        border_effect_css += f"box-shadow:0 0 0 3px color-mix(in srgb, {page_border_color} 22%, transparent);"
    if page_border_enabled and page_border_frame:
        border_effect_css += f"outline:1px solid color-mix(in srgb, {page_border_color} 50%, white);outline-offset:-6px;"
    ...
    return (
        ...
        f"color:{body_color};{border_css}{border_effect_css}box-sizing:border-box;min-height:100%;"
        ...
        ".nf-numbered-root{list-style:none;padding-left:0;}"
        ".nf-numbered-item{display:flex;align-items:flex-start;gap:0.5rem;}"
        ".nf-number-label{min-width:2.75rem;font-variant-numeric:tabular-nums;font-weight:600;color:#475569;}"
        ...
        ".nf-page-num-preview{font-weight:600;font-variant-numeric:tabular-nums;}"
