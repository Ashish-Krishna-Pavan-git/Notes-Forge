...
MARKER_SPECS: Tuple[MarkerSpec, ...] = (
    MarkerSpec(
        ...
        payload_rules="Heading text may continue on following lines until the next marker.",
        aliases=("HEADING",),
    ),
    MarkerSpec(
        key="H2",
    ...
    MarkerSpec(
        key="TIP",
        category="text",
        syntax="TIP: Practical suggestion",
        example='TIP: "Use aliases to keep prompts concise."',
        description="Tip callout paragraph.",
        payload_rules="Continuation lines are included until next marker.",
    ),
    MarkerSpec(
        key="WARNING",
        category="text",
        syntax="WARNING: Caution message",
        example='WARNING: "Do not expose private keys in examples."',
        description="Warning callout paragraph.",
        payload_rules="Continuation lines are included until next marker.",
    ),
    MarkerSpec(
        key="INFO",
        category="text",
        syntax="INFO: Context note",
        example='INFO: "PDF fallback uses the configured conversion chain."',
        description="Informational callout paragraph.",
        payload_rules="Continuation lines are included until next marker.",
    ),
    MarkerSpec(
        key="SUCCESS",
        category="text",
        syntax="SUCCESS: Completion note",
        example='SUCCESS: "All validation checks passed."',
        description="Success callout paragraph.",
        payload_rules="Continuation lines are included until next marker.",
    ),
    MarkerSpec(
        key="CALLOUT",
        category="text",
        syntax="CALLOUT: Emphasized statement",
        example='CALLOUT: "Use strict mode for deterministic output."',
        description="Generic callout paragraph.",
        payload_rules="Continuation lines are included until next marker.",
    ),
    MarkerSpec(
        key="SUMMARY",
        category="text",
        syntax="SUMMARY: Wrap-up statement",
        example='SUMMARY: "This section closes with key outcomes."',
    ...
    MarkerSpec(
        key="CHECKLIST",
        category="list",
        syntax="CHECKLIST: [ ] Item",
        example='CHECKLIST: "[x] Publish release notes"',
        description="Checklist list item.",
        payload_rules="Indentation determines nesting level; [x]/[ ] prefix optional.",
        aliases=("TASK", "TODO"),
    ),
    MarkerSpec(
        key="CODE",
    ...
    MarkerSpec(
        key="EQUATION",
        category="code",
        syntax="EQUATION: E = mc^2",
        example='EQUATION: "\\int_0^1 x^2 dx = 1/3"',
        description="Equation block preserving text exactly.",
        payload_rules="Continuation lines are preserved verbatim until next marker.",
    ),
    MarkerSpec(
        key="ASCII",
    ...
    MarkerSpec(
        ...
        payload_rules="Caption text may continue on following lines until the next marker.",
    ),
    MarkerSpec(
        key="CAPTION",
        category="media",
        syntax="CAPTION: Caption text",
        example='CAPTION: "Figure or table caption"',
        description="Context-aware caption marker. When placed after TABLE it becomes a table caption; after IMAGE/FIGURE/DIAGRAM it becomes a figure caption.",
        payload_rules="Place immediately after the related table/image/diagram block. Caption text may continue on following lines until the next marker.",
    ),
    MarkerSpec(
        key="IMAGE",
        category="media",
    ...
    MarkerSpec(
        ...
        payload_rules="Reference text may continue on following lines until the next marker.",
    ),
    MarkerSpec(
        key="APPENDIX",
        category="academic",
    ...
    MarkerSpec(
        ...
        syntax="SEPARATOR:",
        example="SEPARATOR:",
        description="Horizontal separator marker.",
        payload_rules="No payload required.",
