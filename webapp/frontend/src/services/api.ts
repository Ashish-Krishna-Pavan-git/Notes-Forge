...
import { API, API_TIMEOUT_MS } from "../config/env";
...
export const API_ENDPOINTS = {
  ...
  processingContext: `${API}/api/file-processing/context`,
  processingConvert: `${API}/api/file-processing/convert`,
  processingBatchConvert: `${API}/api/file-processing/convert/batch`,
  processingBatchJob: (jobId: string) =>
    `${API}/api/file-processing/convert/batch/jobs/${jobId}`,
  processingBatchDownload: (jobId: string) =>
    `${API}/api/file-processing/convert/batch/jobs/${jobId}/download`,
